...
install.packages(c('devtools','quantmod','Quandl','fTrading','TTR','robustbase','quadprog','Rglpk','tseries','xts','lubridate','modeest','forecast','pmml','XML','randomForest','deepnet'),repos='http://cran.rstudio.com/')
